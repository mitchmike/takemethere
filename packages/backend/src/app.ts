...
import { simRoutes } from './simulator/routes.js';
import { startPoller, stopPoller } from './stream/ingest/ptv_poller.js';
import { startStreamer, stopStreamer } from './stream/output/emitter.js';
import { setRouteLineMap, setLineStopCoords, setGlobalStopNames, setTripDirections, setPool, setDwellStats } from './stream/engine/static_data.js';
